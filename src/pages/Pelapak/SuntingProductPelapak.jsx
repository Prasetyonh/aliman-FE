            ...
            <div className="h-auto xxl:w-[892px] xl:w-[892px] w-auto pb-5 border border-[#E9E9E9]">
              ...
              <div className="pl-[70px] mt-6 flex flex-col gap-9 text-[24px] text-[#000000B2]">
                ...
                <div className="flex flex-col gap-3 pr-[70px]">
                  ...
                  <input
                    ...
                    value={price}
                    onChange={(event) => {
                      const enteredPrice = parseInt(event.target.value);
                      setPrice(enteredPrice < 0 ? 0 : enteredPrice);
                    }}
                    className="h-[52px] outline-none border border-[#00000040] bg-[#E8F0FD] rounded-md px-2"
                    required
                  />
                ...
                <div className="flex flex-col gap-3 pr-[70px]">
                  ...
                  <input
                    ...
                    value={stock}
                    onChange={(event) => {
                      const enteredStock = parseInt(event.target.value);
                      setStock(enteredStock < 0 ? 0 : enteredStock);
                    }}
                    className="h-[52px] outline-none border border-[#00000040] bg-[#E8F0FD] rounded-md px-2"
                    required
                  />
                ...
                {imagesGroup != null ? (
                  <div className="flex flex-col items-start gap-3 pr-[70px]">
                ...
                {imagesGroup === null ? (
                  <div>
                    <div className="flex xxl:flex-row xl:flex-row flex-col">
                      <div className="flex xxl:flex-row  xl:flex-row flex-col">
                        <div className="flex flex-col gap-3 xxl:pr-[70px] xl:pr-[70px] w-[250px] ">
                          ...
                          <label
                            htmlFor="uploadInput"
                            className="cursor-pointer h-[47px] w-[211px]"
                          >
                      ...
                      <div
                        className={`${
                          openImage ? 'hidden' : ''
                        } w-full flex justify-end pr-[70px] mt-20 text-[21px]`}
                      >
                        <button
                          type="button"
                    ...
                    <div
                      className={`${
                        openImage ? '' : 'hidden'
                      } flex xxl:flex-row xl:flex-row flex-col mt-10`}
                    >
                      <div className="flex xxl:flex-row  xl:flex-row flex-col">
                        <div className="flex flex-col gap-3 xxl:pr-[70px] xl:pr-[70px] w-[250px] ">
                          <p>Upload Gambar</p>
              ...
              <div className="w-full flex xxl:justify-end xl:justify-end lg:justify-end md:justify-end items-center xxl:flex-row xl:flex-row lg:flex-row md:flex-col xs:flex-col s:flex-col gap-[30px] xxl:pr-[70px] xl:pr-[70px] lg:pr-[70px] md:pr-10 mt-10 text-[21px]">
                <Link to={'/pelapak/product-saya'}>
                  <button
                    type="button"
                    className="h-[47px] w-[211px] border border-[#0089FF] rounded-md text-[#2D9CDB]"
                  >
                    Kembali
                  </button>
                </Link>
                <button
                  type="submit"
                  className="h-[47px] w-[211px] border border-[#0089FF] bg-[#2D9CDB] rounded-md text-[#FFFFFF]"
                >
                  Simpan
                </button>
              </div>
